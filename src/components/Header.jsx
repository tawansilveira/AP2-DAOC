...
const Header = () => {
  return (
    <div
      className='
      header-container container bg-gray-900 p-2 border-b-2 border-solid border-gray-950 shadow-md
      sticky transition duration-500 ease-in-out hover:shadow-xl'>
